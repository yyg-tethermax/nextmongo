                    ...
                    <li className={cx("MovieItem")} key={movie._id}>
                        <Link className={cx("MovieLink")} href={`/movies/${movie._id}`}>
                            <div className={cx("ImageWrapper")}>
                                {
                                    movie.poster ? (
                                        <Image className={cx("MoviePoster")} src={movie.poster} alt={movie.title} width={100} height={100} />
                                    ) :(
                                        <Image className={cx("MoviePoster")} src="https://picsum.photos/300/200" alt={movie.title} width={100} height={100} />
                                    )
                                }
