...
import styles from "@/scss/components/loading/MoviesSkeleton.module.scss";
          ...
          <li key={index} className={cx("SkeletonItem")}>
            <div className={cx("SkeletonWrapper")}>
              <Skeleton
                ...
                width={50}
                height={50}
                containerClassName="PosterSkeleton"
              />
            ...
            <Skeleton
              ...
              highlightColor="#444"
              count={3}
              containerClassName={cx("FullplotSkeleton")}
            />
          </li>
        ))}
      </ul>
